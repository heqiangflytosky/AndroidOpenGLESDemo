...
public class ImageMultiEffectRenderer implements GLSurfaceView.Renderer  {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        int vertexShader= ShaderHelper.compileVertexShader(Utils.fileLoader(mContext, R.raw.texture_multi_effect_vertex_shader));
        int fragmentShader=ShaderHelper.compileFragmentShader(Utils.fileLoader(mContext,R.raw.texture_multi_effect_fragment_shader));
